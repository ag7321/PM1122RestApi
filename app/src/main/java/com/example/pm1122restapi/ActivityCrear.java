...
public class ActivityCrear extends AppCompatActivity {
    ...
    private void CrearEmpleado() {
        ...
        parametros.put("nombre","ANGEL");
        parametros.put("apellidos","GARCIA");
        parametros.put("edad","22");

        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, ResApiMetodos.EndPointCrearEmple,
